...
class PreprocessFrame(gym.ObservationWrapper):
    def __init__(self, shape, env=None):
        ...
        self.observtaion_shape = gym.spaces.Box(low=0.0, high=1.0, shape=self.shape, dtype=np.float32)
...
class StakeFrames(gym.ObservationWrapper):
    def __init__(self, env, repeat):
        super(StakeFrames, self).__init__(env)
    ...
    def reset(self):
        self.stack.clear()
        print('THE ENVIRONMENT PONG: ', self.env)
